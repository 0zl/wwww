...
parser.add_argument("--rds-mother", type=str, help="RDS mother", default=None)
parser.add_argument("--rds-global", type=str, help="RDS global", default=None)
parser.add_argument("--stop-sch", type=int, help="Stop schedule (in-minutes)", default=None)
