...
parser.add_argument("--rd", action='store_true', help="enable RDS")
parser.add_argument("--rds-h", type=str, help="RDS host", required=True)
parser.add_argument("--rds-p", type=int, help="RDS port", required=True)
parser.add_argument("--rds-secret", type=str, help="RDS secret", required=True)
parser.add_argument("--rds-id", type=str, help="RDS id", required=True)
parser.add_argument("--rds-mother", type=str, help="RDS mother", required=True)
parser.add_argument("--rds-global", type=str, help="RDS global", required=True)
